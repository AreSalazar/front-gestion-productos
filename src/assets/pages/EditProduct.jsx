            ...
            <form onSubmit={handleSubmit} className="card p-4 shadow-sm border-0 rounded-4">
                ...
                {preview ? (
                    <div className="mb-3">
                        ...
                        <img src={preview} alt="Nueva preview" style={{ width: "200px", borderRadius: "10px", border: "1px solid #ccc" }}
                        />
                    </div>
                ) : currentImage && (
                    <div className="mb-3">
                        <p className="small text-muted">Preview:</p>
                        <img src={`http://127.0.0.1:8000/storage/${currentImage}`} alt="Producto" style={{ width: "200px", borderRadius: "10px", border: "1px solid #ccc" }}
                        />
                    </div>
                )}
